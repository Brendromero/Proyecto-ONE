...
El proyecto se desarrolló en un archivo de Google Colab (`AluraStoreLatam.ipynb`) y contiene las siguientes secciones principales:

1. **Carga y exploración de datos**  
   - Importación de las bases de datos de las cuatro tiendas.

2. **Análisis descriptivo**  
   - Cálculo de métricas clave: ingresos, costos, calificaciones y ventas por categoría.  
   - Identificación de los productos más y menos vendidos.

3. **Visualización de datos**  
   - Gráficos de barras, líneas y circulares para ilustrar los resultados.  
   - Comparaciones entre tiendas.

4. **Informe final**  
   - Resumen de los principales hallazgos.  
   - Conclusión con la tienda recomendada para el Sr. Juan.

---

## Resultados principales
- **Ingresos totales:** La tienda con mayores ingresos fue **Tienda 1**, seguida por las demás.  
- **Categorías más vendidas:** “Electrónica” y “Muebles” dominaron en todas las tiendas.  
- **Calificaciones promedio:** Las tiendas **2 y 3** obtuvieron las mejores valoraciones de los clientes.  
- **Productos más vendidos:** “Microondas”, “Cama box” y “Kit de bancas”.  
